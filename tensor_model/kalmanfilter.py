...
class RSSImeter:
    def __init__(self,_trueRSSI,_noiselevel):
        self.trueRSSI = _trueRSSI
        self.noiselevel = _noiselevel
    def GetRSSI(self):
        return self.trueRSSI
    def GetRSSIWithNoise(self):
        return random.gauss(self.GetRSSI(),self.noiselevel)
