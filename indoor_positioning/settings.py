"""
Django settings for indoor_positioning project.
...
SECRET_KEY = 'uwc5fl6$k$ogt@g(m%_r1m4jqo+4x8_m#!1yr9%!ql8y3rp*(*'
...
ROOT_URLCONF = 'indoor_positioning.urls'
...
WSGI_APPLICATION = 'indoor_positioning.wsgi.application'
